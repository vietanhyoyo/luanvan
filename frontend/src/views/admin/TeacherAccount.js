...
const TeacherAccount = () => {
    ...
    return <MainCard title={<>
        <Typography variant='h4' display={'inline'}>Quản lý khoản giáo viên</Typography>
        <Typography variant='body2' display={'inline'}> : Bạn có thể <Button onClick={() => {
            navigate('/manager/add-teacher');
        }}>Thêm giáo viên</Button></Typography>
    </>}>
